...
+ Troubleshooting
  + Use only the plant frequency
```{r}
#input files
frequency_file <- "Frequency_ByrneDairy_030320.csv"
growth_file <- "ST_percentidentity_forcedNmax_MCinput_SL_030320.csv"
init_file <- "Initialmicro_byrnedairy_MCinput_030220.csv"
```
...
logMPN_mean <- c(0.3839908) #day initial
logMPN_sd <- c(1.298254) #day initial
...
day7andday10<-read.csv("LOGday7and10_byrnedairy_030320.csv")
...
plot(density(na.omit(newlogday14)), main="Day 14 vs 21 VSL/Simulated histogram", 
     xlab="LOG CFU/mL", xlim=c(-2,12), ylim=c(0,1.0))
lines(density(na.omit(newlogday14)), col="red", lty=1) #VSL day 14 data
lines(density(na.omit(day21counts_sim)), col="black", lty=2) #simulated day 21 data
lines(density(na.omit(day14counts_sim)), col="red", lty=2) #simulated day 14 data
