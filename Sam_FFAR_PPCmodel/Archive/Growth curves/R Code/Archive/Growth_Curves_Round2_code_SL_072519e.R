...
#pch= is the symbol and is a dot
overview(R100531modelb)
R100531biotwo<-coef(R100531modelb)

R100531biotwo["BIC_b"]<-BIC(R100531modelb)
R100531biotwo["BIC_g"]<-BIC(R100531modelg)
R100531biotwo["BIC_ba"]<-BIC(R100531modelba)
#BICR100531model<- rbind(BICR100531modelb, BICR100531modelg, BICR100531modelba)
...
overview(R101099modelb)
R101099biotwo<-coef(R101099modelb)

R101099biotwo["BIC_b"]<-BIC(R100531modelb)
R101099biotwo["BIC_g"]<-BIC(R100531modelg)
R101099biotwo["BIC_ba"]<-BIC(R100531modelba)
...
RANDOMTRIALSTUFF<-as.data.frame(rbind(R100531bioone, R100531biotwo))
RANDOMTRIALSTUFF$Bio_Replicate <- 2
