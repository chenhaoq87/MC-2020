...
init_file <- "Initialmicro_garelickfarms_MCinput_030220.csv"
```
...
```{r}
#input files
frequency_file <- "Frequency_Garelick_030420.csv"
growth_file <- "ST_percentidentity_forcedNmax_MCinput_SL_030320.csv"
init_file <- "Initialmicro_garelickfarms_MCinput_030220.csv"
```
...
logMPN_mean <- c(0.6209606) #day initial
logMPN_sd <- c(1.143774) #day initial
...
day7andday10<-read.csv("LOGday7and10_garelick_030220.csv")
