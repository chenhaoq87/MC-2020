...
* duration of storage (aka time) is different for each school (modeling 5 schools); based on Tim's data: mean 36 h, sd 10 h, min 23, max 48 (again, this is temporary, change later), for now, uniform distribution w/ 24, 36, 48 h
