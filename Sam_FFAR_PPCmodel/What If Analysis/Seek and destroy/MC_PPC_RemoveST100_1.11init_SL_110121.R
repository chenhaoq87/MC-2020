...
sink(file = "RemoveST100filecatstatements_1.11init.txt")
...
freq_import2<-freq_import2[!(freq_import2$X16S_ST =="100"),]
newdf <- freq_import2
...
save.image(file = "RemoveST100_ppcmodel_1.11init.RData")
