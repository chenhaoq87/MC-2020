...
sink(file = "Neg60Initconcfilecatstatements_1.11init.txt")
...
data$logMPN_init <- sensanalysis(data$logMPN_init,-0.6) #increase initial conc 
...
save.image(file = "Neg60Initconc_ppcmodel_1.11init.RData")
