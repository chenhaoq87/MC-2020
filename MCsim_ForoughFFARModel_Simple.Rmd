...
n_sim <- 1000 #can use any n_sim for testing code, but need to change to at least 10k when running experiments
...
data$logCount_init  <- -2.5 #change for each of 5 rounds here & in next chunk
```
...
for (i in 1:(n_sim *n_units * n_day)){
  ...
  data$count[i] <- log10N_func(data$day[i],spore_growth_import$lag[allele_index], spore_growth_import$mumax[allele_index], -2.5, spore_growth_import$LOG10Nmax[allele_index])}
```
## 7. Save results
...
#save(data,file="MCsim_result_df_new6.RData")
#save(data,file="MCsim_result_df_new7.RData")
#save(data,file="MCsim_result_df_new8.RData")
#save(data,file="MCsim_result_df_new9.RData")
#save(data,file="MCsim_result_df_new10.RData")
#save(data,file="MCsim_result_df_new11.RData")
#save(data,file="MCsim_result_df_new12.RData")
save(data,file="MCsim_result_df_new13.RData")
#save(data,file="MCsim_result_df_new14.RData")
