...
day7andday10<-read.csv("Log microbial count with SPC_120319.csv")
...
day7counts<- data2_counts[data2_counts$day=="6",] 
...
day10counts<- data2_counts[data2_counts$day=="9",] 
...
```{r}
pdf(file='plot_original_minus2ST_mu_bestcase_low_summary.pdf')
fig_SBD <- ggplot() + geom_bar(aes(y = spoiled_by_day$spoiled, x = spoiled_by_day$days), data = spoiled_by_day, 
                               stat = "identity", color = "black", position = "dodge")+
