...
sink(file = "Removetop60filecatstatements_1.11init.txt")
...
##remove the top60% based on freq fast growers
freq_import2<-freq_import
top20<-read.csv("Top60fastestST_SL_032721.csv")
...
save.image(file = "Removetop60_ppcmodel_1.11init.RData")
