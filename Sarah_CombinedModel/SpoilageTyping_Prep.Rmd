...
5/11/21 - Sarah Murphy reviewed this code with Al Trmcic, Tim Lott, and Sam Lau; for samples that still need to be reviewed, will send email with this code ("SpoilageTyping_Prep.Rmd") and data ("sdf_forReview_051121.csv") to be reviewed to come up with additional rules for spoilage typing
...
#now there are still remaining samples that need to be reviewed to assign spoilage types; send .csv to others to come up with rules
# sdf$spoilagetype[sdf$GN_AtLeast2x=="no" & sdf$Spoiled20000_yn == "yes"]<-"spore" ###proposed rule?
...
# write.csv(reviewdf,"sdf_forReview_051121.csv")
```
