...
spore_ATfrequency_file <- "~/Github/Lab/MC-2020/Tim_ESL/ColdgrowATFreq_CrossSect_NGATs.csv"
...
spore_growth_file <- "~/Github/Lab/MC-2020/Tim_ESL/GrowthParameters_NoGrowthATs.csv" 
...
spore_ATfreq_import$ClosestAT <- paste(spore_ATfreq_import$temp,spore_ATfreq_import$NewClosestAT,sep="_")
...
```
ii. May apply intervention and add results from sampling distribution in (i) to dataframe
```{r}
...
save(ATassign2, file = "ATassign2.RData")
# save(data_intervention, file = "data_intervention.RData")
