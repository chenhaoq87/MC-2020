...
init_file <- "Initialmicro_upstaterochester_MCinput_030220.csv"
```
...
+ Troubleshooting
  + Frequency only from plant
```{r}
#input files
frequency_file <- "Frequency_UpstateRochester_030420.csv"
growth_file <- "ST_percentidentity_forcedNmax_MCinput_SL_030320.csv"
init_file <- "Initialmicro_upstaterochester_MCinput_030220.csv"
```
...
logMPN_mean <- c(0.5305281) #day initial
logMPN_sd <- c(0.9010257) #day initial
...
day7andday10<-read.csv("LOGday7and10_upstaterochester_030220.csv")
