...
sink(file = "ValidationWITHADJUSTMENT1.11logfilecatstatements.txt")
...
temps <- vector()
#temps <- rlaplace(n=(n_sim*n_halfgal),m=6,s=0) # will be using temps vector later
temps <- rnorm(n=(n_sim*n_halfgal),m=6,s=0)
...
save.image(file = "ValidationWITHADJUSTMENT1.11log.RData")
