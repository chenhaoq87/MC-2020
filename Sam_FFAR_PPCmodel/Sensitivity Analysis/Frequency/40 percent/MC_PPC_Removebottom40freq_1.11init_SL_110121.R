...
sink(file = "Removebottom40filecatstatements_1.11init.txt")
...
top20<-read.csv("Top40slowestST_SL_032721.csv")
...
save.image(file = "Removebottom40_ppcmodel_1.11init.RData")
