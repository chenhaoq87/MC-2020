...
for (iso in isolate_list) {
 ...
 # for (i in seq(1, 3)){
    ...
    #draw the plot
    plot(growth_data$t, growth_data$LOG10N, xlim = c(0,360), ylim = c(3,9), xaxt='n', xlab = "Time (hours)", ylab = "LOG10N", pch = 20)
...
write.table(output, file = "Growth_Params_Round3_SL_080719b.csv", sep=",", row.names=FALSE)
