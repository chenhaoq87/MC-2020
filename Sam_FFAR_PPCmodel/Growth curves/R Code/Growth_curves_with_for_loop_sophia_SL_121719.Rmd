...
for (iso in isolate_list) {
 ...
 # for (i in seq(1, 3)){
    ...
    #a plot will be drawn for each isolate with each growth model and be in a PNG file in your folder
...
#all the growth parameters (for all 3 models) will be in this file
write.table(output, file = "Growth_Parameters_SL_121719.csv", sep=",", row.names=FALSE)
