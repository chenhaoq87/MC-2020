...
sink(file = "Pos40Initconcfilecatstatements_1.11init.txt")
...
data$logMPN_init <- sensanalysis(data$logMPN_init,0.4) #increase initial conc 
...
save.image(file = "Pos40Initconc_ppcmodel_1.11init.RData")
