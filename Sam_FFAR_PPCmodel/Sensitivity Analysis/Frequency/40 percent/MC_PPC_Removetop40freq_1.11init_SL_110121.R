...
sink(file = "Removetop40filecatstatements_1.11init.txt")
...
##remove the top40% based on freq fast growers
freq_import2<-freq_import
top20<-read.csv("Top40fastestST_SL_032721.csv")
...
save.image(file = "Removetop40_ppcmodel_1.11init.RData")
