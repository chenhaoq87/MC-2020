...
#get the data
growthmodel2 <- read.csv("Z:/sl2763_Samantha Lau/Projects/2019 FFAR project/Growth curves/R Code/Growth_Curve_Round2_RAWDATA_SL_071919.csv", stringsAsFactors = FALSE)
...
write.table(output, file = "Growth_Params_Round2_SL_082119.csv", sep=",", row.names=FALSE)
