...
Growthparametersround2[, c(4, 1, 2, 3, 5)]
if (i==1) {
  write.table(Growthparametersround2, "Growthparametersround2_072619.csv", row.names = FALSE, sep=",",append=FALSE)
...
write.table(Growthparametersround2, "Growthparametersround2_072619.csv", sep=",",  row.names = FALSE, col.names=FALSE, append=TRUE)
#instead of rewriting the file each time, it adds things to the end
#sep tells it what to write in between , a comma means different column
}
}
