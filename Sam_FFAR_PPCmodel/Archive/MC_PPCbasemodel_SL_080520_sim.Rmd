...
```{r}
#Don't include this here, just include below
...
#   data$count[i] <- log10N(data$day[i]*24, newLag, newMu*0.523,data$logMPN_init[i],growth_import$Nmax[allele_index])
# # data$count[i] <- log10N((data$day[i]*24), 1, 1,data$logMPN_init[i],growth_import$Nmax[allele_index])
# }
# 
# # t, lag, mumax, LOG10N0, LOG10Nmax
# 
...
+ New version so that temp is for each unique BT/hg
```{r}
