...
sink(file = "Removebottom20filecatstatements_1.11init.txt")
...
top20<-read.csv("Top20slowestST_SL_032721.csv")
...
save.image(file = "Removebottom20_ppcmodel_1.11init.RData")
