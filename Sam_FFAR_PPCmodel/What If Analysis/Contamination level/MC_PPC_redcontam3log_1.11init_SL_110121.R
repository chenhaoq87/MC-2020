...
sink(file = "ReduceContamby3filecatstatements_1.11init.txt")
...
data$logMPN_init <- log10(MPN_init_mL)-3 #Add initial logMPN to data frame
...
save.image(file = "ReduceContamby3_ppcmodel_1.11init.RData")
