...
# get PPC frequency data for 1 plant only
# plant_freq_ppc <- df_freqPPC %>%
#   filter(plantID=="I") #randomly chose plantID, as 40 samples
...
data$spore_log10MPN_init <- log10(spore_MPN_init_mL)-1.30 #change this for the bactofuge; Moraru = 0.90 log reduction and TetraPak = 1.30 log reduction
...
```{r}
## ran this
# save(data,file="Baseline_Buffalo_NoBactofuge_AverageSpoilageType_LaplaceTemp_MCsim_result_df.RData")
# save(data,file="Baseline_Buffalo_MoraruBactofuge_AverageSpoilageType_LaplaceTemp_MCsim_result_df.RData")
# save(data,file="Baseline_Buffalo_TetraPakBactofuge_AverageSpoilageType_LaplaceTemp_MCsim_result_df.RData")

# save(data,file="Buffalo_NoBactofuge_WorstPPCVSL434_LaplaceTemp_MCsim_result_df.RData")
# save(data,file="Buffalo_MoraruBactofuge_WorstPPCVSL434_LaplaceTemp_MCsim_result_df.RData")
# save(data,file="Buffalo_TetraPakBactofuge_WorstPPCVSL434_LaplaceTemp_MCsim_result_df.RData")

# save(data,file="Buffalo_NoBactofuge_BestPPCVSL436_LaplaceTemp_MCsim_result_df.RData")
# save(data,file="Buffalo_MoraruBactofuge_BestPPCVSL436_LaplaceTemp_MCsim_result_df.RData")
# save(data,file="Buffalo_TetraPakBactofuge_BestPPCVSL436_LaplaceTemp_MCsim_result_df.RData")

## need to run this
# save(data,file="Baseline_Buffalo_NoBactofuge_AverageSpoilageType_ConstantTemp_MCsim_result_df.RData")
# save(data,file="Baseline_Buffalo_MoraruBactofuge_AverageSpoilageType_ConstantTemp_MCsim_result_df.RData")
# save(data,file="Baseline_Buffalo_TetraPakBactofuge_AverageSpoilageType_ConstantTemp_MCsim_result_df.RData")

# save(data,file="Buffalo_NoBactofuge_WorstPPCVSL434_ConstantTemp_MCsim_result_df.RData")
# save(data,file="Buffalo_MoraruBactofuge_WorstPPCVSL434_ConstantTemp_MCsim_result_df.RData")
# save(data,file="Buffalo_TetraPakBactofuge_WorstPPCVSL434_ConstantTemp_MCsim_result_df.RData")

# save(data,file="Buffalo_NoBactofuge_BestPPCVSL436_ConstantTemp_MCsim_result_df.RData")
# save(data,file="Buffalo_MoraruBactofuge_BestPPCVSL436_ConstantTemp_MCsim_result_df.RData")
# save(data,file="Buffalo_TetraPakBactofuge_BestPPCVSL436_ConstantTemp_MCsim_result_df.RData")
