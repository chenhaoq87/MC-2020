...
ppc_STfreq_import$ClosestST <- ppc_STfreq_import$RealST
...
ppc_growth_import$ST <- paste(ppc_growth_import$temp,ppc_growth_import$ST,sep="_")

spore_growth_import <- spore_growth_import %>%
  .[c(1:5)]%>%
  rename(AT = rpoBAT)
spore_growth_import$temp <- "AT"
spore_growth_import$AT <- paste(spore_growth_import$temp,spore_growth_import$AT,sep="_")
