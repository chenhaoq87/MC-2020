...
init_file <- "Initialmicro_hoodconcord_MCinput_030220.csv"
```
...
```{r}
#input files
frequency_file <- "Frequency_HoodConcord_030420.csv"
growth_file <- "ST_percentidentity_forcedNmax_MCinput_SL_030320.csv"
init_file <- "Initialmicro_hoodconcord_MCinput_030220.csv"
```
...
logMPN_mean <- c(0.1055327) #day initial
logMPN_sd <- c(1.41451) #day initial
...
day7andday10<-read.csv("LOGday7and10_hoodconcord_030220.csv")
