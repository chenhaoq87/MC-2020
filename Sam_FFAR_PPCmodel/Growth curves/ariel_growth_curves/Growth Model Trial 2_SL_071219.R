...
growthmodel2 <- read.csv("growthmodeltrial2.csv")
...
H80287modelb <- nls(buchanan, H80287,
                    list(lag = 9, mumax=1, LOG10N0=3, LOG10Nmax=9))
...
#to look at what the actual values of lag, mumax, etc are, use this code
overview(J30123modelb)
...
#if start values of lag, mumax, etc are too far from the actual, it won't converge
