...
R100531 <- growthmodel2[growthmodel2$Isolate=="FSL R10-0531"& growthmodel2$BioRep=="2", ] #the ending comma
...
R101099 <- growthmodel2[growthmodel2$Isolate=="FSL R10-1099"& growthmodel2$BioRep=="2", ]
...
R101113 <- growthmodel2[growthmodel2$Isolate=="FSL R10-1113"& growthmodel2$BioRep=="2", ]
...
R100941 <- growthmodel2[growthmodel2$Isolate=="FSL R10-0941"& growthmodel2$BioRep=="2", ]
...
R100054 <- growthmodel2[growthmodel2$Isolate=="FSL R10-0054"& growthmodel2$BioRep=="2", ]
...
R100151 <- growthmodel2[growthmodel2$Isolate=="FSL R10-0151"& growthmodel2$BioRep=="2", ]
...
R100553 <- growthmodel2[growthmodel2$Isolate=="FSL R10-0553"& growthmodel2$BioRep=="2", ]
...
Isolatesbioreptwo<-as.data.frame(rbind(R100531bioone, R101099bioone, R101113bioone, R100941bioone, R100054bioone,  R100151bioone, R100553bioone))
Isolatesbioreptwo$Bio_Replicate <- 2

write.csv(Isolatesbioreptwo, "Isolatesbioreptwo_072919.csv")
