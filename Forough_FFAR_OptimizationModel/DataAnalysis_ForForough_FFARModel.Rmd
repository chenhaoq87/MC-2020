...
#df_F5 <- data
load("MCsim_result_df_new1.RData")
df_F1 <- data
load("MCsim_result_df_new2.RData")
df_F2 <- data
load("MCsim_result_df_new3.RData")
df_F3 <- data
load("MCsim_result_df_new4.RData")
df_F4 <- data
load("MCsim_result_df_new5.RData")
df_F5 <- data
...
# write.csv(data, "data_032620.csv")
```
...
#get data
data1 <- data %>%
  filter(logCount_init == "-1.989")

data2 <- data %>%
  filter(logCount_init == "-1.239")

data3 <- data %>%
  filter(logCount_init == "-0.72")

data4 <- data %>%
  filter(logCount_init == "-0.201")

data5 <- data %>%
  filter(logCount_init == "0.549")
