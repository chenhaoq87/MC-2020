...
sink(file = "TempNeg40filecatstatements_1.11init.txt")
...
temps <- vector()
temps <- rlaplace(n=(n_sim*n_halfgal),m=2.436,s=2.31) # will be using temps vector later
...
for (i in 1:(n_sim*n_halfgal)){
  number <- rlaplace(1,m=2.436,s=2.31)
...
save.image(file = "TempNeg40_ppcmodel_1.11init.RData")
