...
Isolatesbiorepone<-as.data.frame(rbind(R100531bioone, R101099bioone, R101113bioone, R100941bioone, R100054bioone,  R100151bioone, R100553bioone))
Isolatesbiorepone$Bio_Replicate <- 1
