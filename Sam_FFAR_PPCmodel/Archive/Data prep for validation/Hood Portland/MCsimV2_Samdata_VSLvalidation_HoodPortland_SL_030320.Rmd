...
init_file <- "Initialmicro_hoodportland_MCinput_030220.csv"
```
...
```{r}
#input files
frequency_file <- "Frequency_HoodPortland_030420.csv"
growth_file <- "ST_percentidentity_forcedNmax_MCinput_SL_030320.csv"
init_file <- "Initialmicro_hoodportland_MCinput_030220.csv"
```
...
logMPN_mean <- c(-0.1415208) #day initial
logMPN_sd <- c(0.9292312) #day initial
...
day7andday10<-read.csv("LOGday7and10_hoodportland_030220.csv")
