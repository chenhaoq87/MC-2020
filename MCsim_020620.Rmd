...
## 4. Prepare distributions to sample from using input data
```{r}
## (1) Initial contamination: logMPN normal distribution
#NEED TO ADDRESS WHY NOT CURRENTLY USING THE INPUT DATA
#Question (Sarah): How is the initialcount_import data used? Where did logMPN_mean and logMPN_sd come from?
...
## (3) Temperature distribution for each stage (Note for Sarah to fix)
