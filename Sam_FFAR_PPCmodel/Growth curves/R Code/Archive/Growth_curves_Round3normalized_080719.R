...
#get the data
growthmodel2 <- read.csv("Growth_Curve_Round3_RAWDATAnormalized_SL_080719.csv", stringsAsFactors = FALSE)
names(growthmodel2) <- c("t","Isolate","LogCount_Norm","Count_Norm", "Biorep") 
...
write.table(output, file = "Growth_Params_Round3_norm_SL_080719.csv", sep=",", row.names=FALSE)
