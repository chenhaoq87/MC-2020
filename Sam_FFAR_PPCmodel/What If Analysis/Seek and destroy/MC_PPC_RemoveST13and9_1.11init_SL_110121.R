...
sink(file = "RemoveST13and9filecatstatements_1.11init.txt")
...
freq_import2<-freq_import2[!(freq_import2$X16S_ST =="13"),]
freq_import2<-freq_import2[!(freq_import2$X16S_ST =="9"),]
newdf <- freq_import2
...
save.image(file = "RemoveST13and9_ppcmodel_1.11init.RData")
