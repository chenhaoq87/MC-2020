...
data2 <- data %>%
  filter(logCount_init == "-6.8")

data3 <- data %>%
  filter(logCount_init == "-2.978")

data4 <- data %>%
  filter(logCount_init == "-7.3")

data5 <- data %>%
  filter(logCount_init == "-10")
