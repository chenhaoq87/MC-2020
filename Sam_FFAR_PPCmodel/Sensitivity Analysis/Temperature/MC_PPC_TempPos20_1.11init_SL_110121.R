...
sink(file = "TempPos20filecatstatements_1.11init.txt")
...
temps <- vector()
temps <- rlaplace(n=(n_sim*n_halfgal),m=4.872,s=2.31) # will be using temps vector later
...
for (i in 1:(n_sim*n_halfgal)){
  number <- rlaplace(1,m=4.872,s=2.31)
...
save.image(file = "TempPos20_ppcmodel_1.11init.RData")
