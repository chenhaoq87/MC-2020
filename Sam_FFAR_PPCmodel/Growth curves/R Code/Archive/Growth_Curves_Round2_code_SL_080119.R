...
R100531bioone<-coef(R100531modelg)

R100531bioone["Isolate"] <- R100531$Isolate[1]
...
R101099bioone["Isolate"] <- R101099$Isolate[1]
...
R101113bioone["Isolate"] <- R101113$Isolate[1]
...
R100941bioone["Isolate"] <- R100941$Isolate[1]
...
R100054bioone<-coef(R100054modelg)

R100054bioone["Isolate"] <- R100054$Isolate[1]
...
R100151bioone["Isolate"] <- R100151$Isolate[1]
...
R100553bioone["Isolate"] <- R100553$Isolate[1]
...
Growthparametersround2<-as.data.frame(rbind(R100531bioone, R101099bioone, R101113bioone, R100941bioone, R100054bioone,  R100151bioone, R100553bioone))
Growthparametersround2$Bio_Replicate <- i
Growthparametersround2<-Growthparametersround2[, c(5, 9, 1, 2, 3, 4, 6, 7, 8)]
if (i==1) {
  write.table(Growthparametersround2, "Growthparametersround2_080119.csv", row.names = FALSE, sep=",",append=FALSE)
...
write.table(Growthparametersround2, "Growthparametersround2_080119.csv", sep=",",  row.names = FALSE, col.names=FALSE, append=TRUE)
