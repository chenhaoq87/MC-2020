...
if (i==1) {
  write.table(Growthparametersround2, "Growthparametersround2_073019.csv", row.names = FALSE, sep=",",append=FALSE)
...
write.table(Growthparametersround2, "Growthparametersround2_073019.csv", sep=",",  row.names = FALSE, col.names=FALSE, append=TRUE)
