...
init_file <- "Initialmicro_stewarts_MCinput_030220.csv"
```
...
+ Troubleshooting
  + Frequency from only plant
```{r}
#input files
frequency_file <- "Frequency_Stewarts_030420.csv"
growth_file <- "ST_percentidentity_forcedNmax_MCinput_SL_030320.csv"
init_file <- "Initialmicro_stewarts_MCinput_030220.csv"
```
...
logMPN_mean <- c(0.4275544) #day initial
logMPN_sd <- c(1.349259) #day initial
...
day7andday10<-read.csv("LOGday7and10_stewarts_030220.csv")
