...
library(AICcmodavg) #GETBICVALUES
...
new_filename = paste("Plot", "isolate", "R100531", "biorep", i,  sep="_")
...
#colnames(Growthparametersround2b)[3]<-"lagb"
#colnames(Growthparametersround2b)[c(3, 4, 5, 6)] <- c("lagb", "mumax_b", "LOG10N0_b", "LOG10Nmax_b")
...
if (i==1) {
  write.table(Growthparametersall, "Growthparametersall_080319.csv", row.names = FALSE, sep=",",append=FALSE)
...
write.table(Growthparametersall, "Growthparametersall_080319.csv", sep=",",  row.names = FALSE, col.names=FALSE, append=TRUE)
