...
# (i) spore data
spore_MPNdata$log10left <- log10(spore_MPNdata$left)
spore_MPNdata$log10right <- log10(spore_MPNdata$right)
spore_MPNdata$log10MPN <- log10(spore_MPNdata$MPN)
cens_data <- spore_MPNdata[,c("log10left","log10right")]
names(cens_data) <- c("left","right")
spore_fit <- fitdistcens(censdata = cens_data,distr = "norm")
hist(spore_MPNdata$log10MPN,freq=F,xlim = c(-4,4))
